...
<div id="header">
    <div class="row">
        <div class="col-sm-12">
            <div class="col-sm-6 ">
                <button class="btn btn-outline btn-primary" id="linkurl_add">添加</button>
            </div>
        </div>
    </div>
</div>
...
<script type="text/javascript">
    $(function () {
        ...
        //修改用户
        var edit_info={
            url:"<?=Url::to(["linkurl/edit"])?>",
            title: '<span class="glyphicon glyphicon-user"></span>&nbsp;修改链接',
            callback:load_data,
        ...
        //弹出一个iframe层
        $('#linkurl_add').on('click', function () {
            var add = {
                title: '<span class="glyphicon glyphicon-user"></span>&nbsp;添加链接',
                content: "<?=Url::to(["linkurl/add"]);?>",
                width:"550px",
                height:"240px",
                callback:load_data,
                current_num:current_num,
