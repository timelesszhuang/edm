...
<div id="nosendemailconfig_add_html">
    <div class="nosendemailconfig_add_content">
        <form action="" id="nosendemailconfig_add_form">
            <input type="hidden" name="_csrf" value="<?=Yii::$app->request->getCsrfToken() ?>">
            <div class="form-group">
                <label for="user_name" class="col-xs-2 control-label">Email:</label>
                <div class="col-xs-10">
                    <input type="text" class="form-control" name="UnsendEmail[email]">
            ...
            <div class="form-group">
                ...
                <div class="col-xs-10">
                    <input type="text" class="form-control" name="UnsendEmail[detail]">
                    <span class="help-block m-b-none error"  name="detail"></span>
                </div>
            </div>
            <div class="form-group">
                <div class="col-xs-12 control-label">
                    <button class="btn btn-sm btn-primary" id="nosendemailconfig_add_post" type="button">添加</button>
...
<script>
    $(function(){
        var user_add_info=(function(){
            return {
                add_url:"<?=Url::to(["nosendemailconfig/add"])?>",
            };
        })();

        $("#nosendemailconfig_add_post").click(function(){
            var data=$("#nosendemailconfig_add_form").serialize();
