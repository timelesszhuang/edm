...
<div id="header">
    <div class="row">
        <div class="col-sm-12">
            <div class="col-sm-6 ">
                <button class="btn btn-outline btn-primary" id="linktype_add">添加</button>
            </div>
        </div>
    </div>
</div>
...
<script type="text/javascript">
    $(function () {
        ...
        //弹出一个iframe层
        $('#linktype_add').on('click', function () {
            var add = {
                title: '<span class="glyphicon glyphicon-user"></span>&nbsp;添加类型',
                content: "<?=Url::to(["linktype/add"]);?>",
                width:"500px",
                height:"220px",
                callback:load_data,
                current_num:current_num,
